...
for(G in 1:GENS){
  ...
  #Save prey results
  save(prey_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_65000g_Prey_V2.Rda')
  save(prey_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_65000g_Prey_details_V2.Rda')
  
  #Save predator results
  save(pred_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_65000g_Pred_V2.Rda')
  save(pred_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_65000g_Pred_details_V2.Rda')
