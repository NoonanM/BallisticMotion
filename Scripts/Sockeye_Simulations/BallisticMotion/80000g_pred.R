...
for(G in 1:GENS){
  ...
  #Save prey results
  save(prey_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_80000g_Prey_decline.Rda')
  save(prey_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_80000g_Prey_details_decline.Rda')
  
  #Save predator results
  save(pred_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_80000g_Pred_decline.Rda')
  save(pred_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_80000g_Pred_details_decline.Rda')
