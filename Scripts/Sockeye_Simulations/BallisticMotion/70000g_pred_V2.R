...
for(G in 1:GENS){
  ...
  for(R in 1:REPS){
    ...
    if(G == 1){
      ...
      for(i in 1:n_pred){
        ...
        pred_tau_v <- sample(1:((pred_tau_p/2)-1), 1)
  ...
  #Save prey results
  save(prey_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_70000g_Prey_V2.Rda')
  save(prey_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_70000g_Prey_details_V2.Rda')
  
  #Save predator results
  save(pred_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_70000g_Pred_V2.Rda')
  save(pred_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_70000g_Pred_details_V2.Rda')
