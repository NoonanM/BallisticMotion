...
for(G in 1:GENS){
  ...
  for(R in 1:REPS){
    ...
    if(G != 1){
      ...
      for(i in 1:n_prey){
        ...
        prey_tau_v <- sample(PREY_tau_v, 1) + rnorm(0.1, 0, 2)  #Add some 'mutation' based variance
  ...
  #Save prey results
  save(prey_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_45000g_Prey_test.Rda')
  save(prey_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_45000g_Prey_details_test.Rda')
  
  #Save predator results
  save(pred_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_45000g_Pred_test.Rda')
  save(pred_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_45000g_Pred_details_test.Rda')
