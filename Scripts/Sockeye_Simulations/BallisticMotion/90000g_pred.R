...
for(G in 1:GENS){
  ...
  #Save prey results
  save(prey_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_90000g_Prey.Rda')
  save(prey_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_90000g_Prey_details.Rda')
  
  #Save predator results
  save(pred_res, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_90000g_Pred.Rda')
  save(pred_details, file = '/scratch/st-mnoonan-1/BallisticMotion/Results/lv_Evo_90000g_Pred_details.Rda')
