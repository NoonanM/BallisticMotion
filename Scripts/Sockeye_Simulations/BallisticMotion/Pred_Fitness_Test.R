...
for(G in 1:GENS){
  ...
  #Save prey results
  save(prey_res, file = 'Results/lv_Evo_40000g_Prey_FitnessTest.Rda')
  save(prey_details, file = 'Results/lv_Evo_40000g_Prey_details_FitnessTest.Rda')
  
  #Save predator results
  save(pred_res, file = 'Results/lv_Evo_40000g_Pred_FitnessTest.Rda')
  save(pred_details, file = '/Results/lv_Evo_40000g_Pred_details_FitnessTest.Rda')
